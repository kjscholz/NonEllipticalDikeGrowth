...
tic
% variables
Pe  = 1e6; % constant excess pressure (Pa)
param.zi = -1e3; % z-coordinate of injection point (m)
param.rho_m        = 2100;     % density fluid (kg/m3)
...
[param_out, store_yo, store_zo,store_dh_dt,store_del,...
    store_p_g_total,store_p_g_ex,store_p_g_grav,store_p_g_volcano,store_lo] =...
    mainDikePropagate_debug(F, a_0,Pe,time_vector,n,param); % run mainChamber.m
compute_time = toc
